...
% Preamble:
  ...
  \usepackage[backend=biber, style=numeric-comp, maxbibnames=99, sorting=ydnt, giveninits, terseinits]{biblatex} % note 'giveninits' replaces 'firstinits' for some stupid reason
