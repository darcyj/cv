...
\begin{adjustwidth}{5mm}{}
  \begin{multicols}{2}
    \begin{itemize}[noitemsep,topsep=0pt, leftmargin=0mm]
      ...
      \item 1436 citations (as of Aug 2020)
      \item h-index = 17
      \item i10-index = 23
    \end{itemize}
  \end{multicols}
...
\begin{itemize}[noitemsep,topsep=0pt, leftmargin=5mm]
  ...
  \item Advised Solon A’s honors thesis project in 2016. Student used Illumina sequencing to compare microbial communities from multiple sites in the Chilean Atacama Desert, and this work is now published in Microbial Ecology \cite{Solon2018}. Student was awarded summa cum laude.
